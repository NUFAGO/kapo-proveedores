...
// Constantes para autenticación de proveedores
export const AUTH_PROVEEDOR_COOKIE_NAME = 'auth_proveedor_token';
export const REFRESH_PROVEEDOR_TOKEN_KEY = 'refresh_proveedor_token';
export const PROVEEDOR_USER_KEY = 'proveedor_user';
